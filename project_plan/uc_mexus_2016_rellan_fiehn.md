...
![metabolic_pathways](../figures/metabolic pathways_comb.png) **figureure 1** A) Biosynthetic pathway of plant glycerolipids. Adapted from Okazaki and cols[@Okazaki:2013dw]. Abbreviations:   B) Different metabolic variables that can be used in association or linkage mapping studies. Letters represent metabolites and numbers enzymes of an hypothetical pathways.  
